...
from sam_model.config.paths_config import model_paths
from sam_model.models.encoders import psp_encoders
from sam_model.models.stylegan2.model import Generator
...
class pSp(nn.Module):
    ...
    def load_weights(self):
        if self.opts.checkpoint_path is not None:
            ...
            print(f'Loading decoder weights from pretrained path: {
                  self.opts.stylegan_weights}')
    ...
    def __load_pretrained_psp_encoder(self):
        print(f'Loading pSp encoder from checkpoint: {
              self.opts.pretrained_psp_path}')
